...
// This file is part of Lucas-porto-2-nextJs.
							...
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									<motion.p
										...
										Hi! I&rsquo;am Lucas, A junior fullstack developer specializing in
										modern Software Development with a growing focus on Artificial
										Intelligence. Passionate about building scalable,
										user-friendly applications and exploring AI technologies.
									</motion.p>
									<motion.div
							...
							<div className="relative md:h-screen w-screen gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
									...
									<motion.p
										...
										These are my favourite articles and posts{" "}
										<span className="bg-transparent md:bg-gray-100 bg-opacity-50 xl:bg-transparent">
											{" "}
											and enjoy to write all the time.
										</span>
									</motion.p>
									<motion.div
										initial={{ y: 40, opacity: 0 }}
										...
										<Button variation="primary">
											<Link href="/posts">Go to see</Link>
										</Button>
									</motion.div>
								</div>
							</div>
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<motion.p
										...
										<a href="mailto:stormrunner06106@gmail.com?subject=Hello&body=Hello Lucas,">
											stormrunner06106@gmail.com
										</a>
									</motion.p>
									{/* icons */}
