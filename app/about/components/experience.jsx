...
const experiences = [
	{
		...
		startDate: "Apr 2013",
		endDate: "2015",
		company: "University IT Club",
		position: "Web Developer",
		type: "Volunteered Developer",
		location: "Toronto, Canada",
		description:
			"By my buddy's request, I started to learn and developing product-level applications since then. With passionate students of university, I think I spent good time on my learning life.",
		skills: [
			"PHP",
			"C/C++, C#"
		],
	...
	},
	{
		...
		location: "Singapore",
		description:
			"Started career as a freelancer directly after graduation; built a successful portfolio and network of clients.Overcame early career challenges to establish a top-ranked freelance profile through persistence and quality delivery.",
		skills: ["Native Java", "Android", "Wordpress"],
	},
	{
		id: 4,
		startDate: "Jun 2020",
		...
		description:
			...
			Built and maintained Galler-ai, a generative image creation platform powered by OpenAI,
			widely recognized for image quality and stability.`,
		skills: ["AI", "Azure AI", "NextJS", "Django", "Android & iOS"],
	},
	{
		id: 5,
		startDate: "Mar 2023",
